...
export function useFundWallet() {
  ...
  const { ready, authenticated, user, connectOrCreateWallet } = privy
  ...
  // Debug logging
  console.log('[FUND WALLET DEBUG] Privy object keys:', Object.keys(privy))
  console.log('[FUND WALLET DEBUG] Ready:', ready)
  console.log('[FUND WALLET DEBUG] Authenticated:', authenticated)
  console.log('[FUND WALLET DEBUG] User:', user)
  console.log('[FUND WALLET DEBUG] Wallets array:', wallets)
  console.log('[FUND WALLET DEBUG] CreateWallet function available:', typeof createWallet === 'function')
  console.log('[FUND WALLET DEBUG] ConnectOrCreateWallet function available:', typeof connectOrCreateWallet === 'function')
  ...
  console.log('[FUND WALLET DEBUG] Privy wallet found:', privyWallet)
  console.log('[FUND WALLET DEBUG] Fundable wallet found:', fundableWallet)
