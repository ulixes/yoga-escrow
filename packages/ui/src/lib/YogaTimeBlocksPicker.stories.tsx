...
import { YogaTimeBlocksPicker, YogaDay, YogaTimeItem } from './YogaTimeBlocksPicker'

const meta: Meta<typeof YogaTimeBlocksPicker> = {
  title: 'Ulyx/YogaTimeBlocksPicker',
  component: YogaTimeBlocksPicker,
}
export default meta

type Story = StoryObj<typeof YogaTimeBlocksPicker>
...
export const GroupedBlocks: Story = {
  render: () => {
    const [selected, setSelected] = useState<string[]>([])
    return (
      <div data-skin="ulyxes" style={{ maxWidth: 560 }}>
